    ...
    public static class AzureAdB2CAuthenticationBuilderExtensions
    {
        ...
        public class OpenIdConnectOptionsSetup : IConfigureNamedOptions<OpenIdConnectOptions>
        {
            ...
            public Task OnRedirectToIdentityProvider(RedirectContext context)
            {
                ...
                context.ProtocolMessage.RedirectUri = AzureAdB2COptions.GetRedirectUrl(context.Request, AzureAdB2COptions.CallbackPath);
            ...
            public async Task OnAuthorizationCodeReceived(AuthorizationCodeReceivedContext context)
            {
                ...
                var authority = AzureAdB2COptions.Authority;
                ...
                IConfidentialClientApplication cca = ConfidentialClientApplicationBuilder.Create(AzureAdB2COptions.ClientId)
                    ...
                    .WithRedirectUri(AzureAdB2COptions.GetRedirectUrl(context.Request, AzureAdB2COptions.CallbackPath))
